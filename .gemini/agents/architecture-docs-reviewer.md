...
1. Read the project's `GEMINI.md`, `README.md`, and `docs/architecture.md` to understand the documented architecture.
...
- **Consistency**: Do different docs agree with each other? Does GEMINI.md match architecture.md match inline code comments?
...
3. **Resource ID check**: Verify resource IDs against what's in GEMINI.md and deployment scripts.
