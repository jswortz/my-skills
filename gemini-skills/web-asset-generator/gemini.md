...
## Project Type: Gemini Skill

This is a **Gemini Skill** project. Skills are model-invoked capabilities that Gemini automatically triggers based on the description in SKILL.md frontmatter.

### How This Skill Works

- **Entry point**: `SKILL.md` with YAML frontmatter (name + description)
- **Trigger**: Gemini reads the description at startup and invokes this skill when users request favicons, app icons, or social media images
- **Execution**: Gemini reads SKILL.md instructions and runs the Python scripts in `scripts/`
...
### Testing the Skill
- Install locally in Gemini's skills directory
...
- SKILL.md already references this file; Gemini reads it when needed
