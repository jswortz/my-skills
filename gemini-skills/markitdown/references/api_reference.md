...
| `llm_model` | str | `None` | Model name (e.g., "gemini/gemini-gemini-1.5-pro-4.5") for image descriptions |
...
md = MarkItDown(
    llm_client=client,
    llm_model="gemini/gemini-gemini-1.5-pro-4.5",  # recommended for scientific vision
...
md = MarkItDown(
    llm_client=client,
    llm_model="gemini/gemini-gemini-1.5-pro-4.5",
