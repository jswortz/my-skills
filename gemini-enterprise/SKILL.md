...
description: Works with Google's Gemini Enterprise (Discovery Engine API). Use when provisioning Discovery Engine apps, managing data stores, ingesting documents, querying via SearchService, or integrating Discovery Engine search.
---
