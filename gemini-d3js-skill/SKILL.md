---
name: gemini-d3js-skill
description: Creates interactive data visualizations using d3.js. Use when creating custom charts, network diagrams, or complex SVG-based data visualizations.
---
