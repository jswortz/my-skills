...
description: Analyzes smart contract codebases to identify state-changing entry points for security auditing. Detects externally callable functions, categorizes them by access level, and generates audit reports. Use when auditing smart contracts.
---
